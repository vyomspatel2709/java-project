...
<html>
   ...
   <body class="sub_page">
      ...
      <section class="product_section layout_padding">
         <div class="container">
            ...
            <div class="row">
            	<%
            		...
            		for(Cart w:list)
            		{
            			net_price=net_price+w.getTotal_price();
               ...
               <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="box">
                     ...
                     <div class="detail-box">
                        <h6>
                           Price : <%=w.getProduct_price() %>
                        </h6>
                     </div>
                     <div class="detail-box">
                           Quantity : 
                           <form name="change_qty" method="post" action="CartController">
                           	<input type="hidden" name="cid" value="<%=w.getCid()%>">
                           	<input type="number" name="product_qty" value="<%=w.getProduct_qty()%>" min="1" max="10" style="width: 100px;height: 30px;" onchange="this.form.submit();">
                           </form>
                     </div>
                     <div class="detail-box">
                        <h6>
                           Total Price : <%=w.getTotal_price() %>
                        </h6>
                     </div>
                  </div>
               </div>
         ...
         <h2 align="center">Net Price To Pay : <%=net_price %></h2>
